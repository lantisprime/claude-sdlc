...
The blocking hooks establish trust:
...
**Junior engineers.** The plugin behaves like a patient senior who insists on a plan before touching code. Adjacent-function warnings catch the "while I'm here" reflex early. The discipline is real, and so is the friction; teams onboarding juniors should expect some initial frustration before the workflow becomes habitual.
