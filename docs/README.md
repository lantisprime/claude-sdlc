...
| [rfcs/archived/RFC-004-maintainer-code-review-enforcement.md](rfcs/archived/RFC-004-maintainer-code-review-enforcement.md) | Maintainer Pre-Merge Multi-Reviewer Gate | implemented | rfc-archived | Four-layer pre-merge gate for maintainer PRs (Revision 2, all 5 PRs shipped 2026-04-28): AGENT-RULES.md §14 rule, four parallel Haiku 4.5 review agents under .claude/agents/maintainer-{security,code-quality,test-adequacy,dependency}-reviewer.md, .claude/hooks/pre-merge-review-gate.sh Stop hook (warn — checks all four artifacts), .github/workflows/pr-review.yml CI gate. Doc-only bypass; consuming-repo artifacts untouched. Branch protection PUT required after merge to enforce. |
| [rfcs/archived/RFC-006-rfc-lifecycle-quality-gates.md](rfcs/archived/RFC-006-rfc-lifecycle-quality-gates.md) | RFC Lifecycle Quality Gates and Build-Stage Enforcement | implemented | rfc-archived | Machine-verifiable lifecycle gates + build-stage loop + AI-slop enforcement, all 8 PRs shipped 2026-04-30. .claude/hooks/rfc-quality-gate.sh + .claude/hooks/ai-slop-check.sh (warn-only), .claude/agents/rfc-pr-reviewer.md (Haiku 4.5), §3.5 Building per-PR loop in AGENT-RULES.md, §2–§7 gate checklists, §3a slop-check field tightening, TEMPLATE.md format reconciliation. Strictly maintainer-only — every artifact under .claude/ paths; plugin capability counts (hooks=14, agents=5) unchanged. |
...
| [rfcs/archived/RFC-004-maintainer-code-review-enforcement.md](rfcs/archived/RFC-004-maintainer-code-review-enforcement.md) | **implemented** | references/_repo-context.md, rfcs/pending-analysis.md | references/_repo-context.md (capability counts unchanged — maintainer-only), references/workflow-log.md, rfcs/README.md (queue removal) |
| [rfcs/archived/RFC-006-rfc-lifecycle-quality-gates.md](rfcs/archived/RFC-006-rfc-lifecycle-quality-gates.md) | **implemented** | references/_repo-context.md, rfcs/pending-analysis.md | references/_repo-context.md (capability counts unchanged — maintainer-only), references/workflow-log.md, rfcs/README.md (queue removal), rfcs/pending-analysis.md |
