...
| [rfcs/RFC-003-hook-enforcement-alignment.md](rfcs/RFC-003-hook-enforcement-alignment.md) | Hook Enforcement Alignment | draft | rfc | Closes four gaps between USER-MANUAL.md enforcement claims and actual hook implementations: phase-gate.sh registration + severity, placeholder field validation, work-item file-level traceability, enforcement language audit |
...
| [rfcs/RFC-003-hook-enforcement-alignment.md](rfcs/RFC-003-hook-enforcement-alignment.md) | **draft** | references/_repo-context.md | USER-MANUAL.md, SDLC.md, references/_repo-context.md |
