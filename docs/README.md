...
| [rfcs/RFC-004-maintainer-code-review-enforcement.md](rfcs/RFC-004-maintainer-code-review-enforcement.md) | Maintainer Pre-Merge Multi-Reviewer Gate | accepted | rfc | Four-layer pre-merge gate for maintainer PRs (Revision 2, 2026-04-28): AGENT-RULES.md §14 rule, four parallel Haiku 4.5 review agents under .claude/agents/maintainer-{security,code-quality,test-adequacy,dependency}-reviewer.md, .claude/hooks/pre-merge-review-gate.sh Stop hook (warn — checks all four artifacts), .github/workflows/pr-review.yml CI gate. 5 PRs. Doc-only PRs bypass; consuming-repo artifacts untouched. Cross-RFC .claude/settings.json coordination with RFC-006 PR-5 |
